...
//   }
//   getUsers('Vincent');
function getGenderDatas(name_or_email) {
    return __awaiter(this, void 0, void 0, function () {
        var url, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://api.genderize.io/?name=".concat(name_or_email);
...
exports.getGenderDatas = getGenderDatas;
